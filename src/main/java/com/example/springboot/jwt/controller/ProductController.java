...
import com.example.springboot.jwt.security.rbac.PrivilegeLookup.Privileges;
...
//    @PreAuthorize("hasAuthority('STAFF_MEMBER')")
	@PreAuthorize("@customRbacAuthorizationHandler.isPrivilegeAssigned('PRODUCTS_READ')")
...
//    @PreAuthorize("hasAnyAuthority('ASSISTANT_MANAGER', 'MANAGER', 'ADMIN')")
	@PreAuthorize("@customRbacAuthorizationHandler.isPrivilegeAssigned('PRODUCTS_WRITE')")
...
//    @PreAuthorize("hasAnyAuthority('ADMIN', 'MANAGER')")
	@PreAuthorize("@customRbacAuthorizationHandler.isPrivilegeAssigned('PRODUCTS_DELETE')")
